...
public class CompanyDAO extends BaseHibernateDAO {
	...
	public List findByExample(Company instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.spicy.domain.Company").add(Example.create(instance))
					.list();
	...
	public List findByRegNumber(Object regNumber) {
		return findByProperty(REG_NUMBER, regNumber);
	}
